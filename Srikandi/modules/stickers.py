...
from Srikandi import BOT_USERNAME, SUDOERS, app, eor
from Srikandi.core.decorators.errors import capture_err
from Srikandi.utils.dbfunctions import del_packname, get_packname, set_packname
from Srikandi.utils.files import (
    get_document_from_file_id,
    resize_file_to_sticker_size,
    upload_document,
)
from Srikandi.utils.stickerset import (
    add_sticker_to_set,
    create_sticker,
    create_sticker_set,
